...
# "Fp" asks for the first number in the range in the example below "0" which is 
# where the range will begin
# "Ep" asks for the second number in the range in the example below "15" which is
# where the range will end
# "Incr" asks for the third number in the range in the example below "1" which is 
...
def plot_func(Fp,Ep,Incr):
    x = np.arange(Fp,Ep,Incr)
...
plot_func(float(input("Enter the first point of the range:\n"))
        ,float(input("Enter the last point of the range:\n"))
        ,float(input("Enter the increments you want the range to incease in:\n")))
